(function () {
  ...
  const copy = {
    ...
    en: {
      ...
      "project.roomie.intro": "At Roomie, I develop editorial universes that connect fashion, art, and culture. My work combines visual judgment, research, and narrative to transform ideas into presentations, content, and graphic series with a recognizable identity.",
      "project.roomie.moodboardTitle": "Roomie Archive",
      "project.roomie.moodboardCopy": "Photographs from Roomie’s archive: scenes, people, spaces, and moments that document its history and community.",
      "project.roomie.universeTitle": "Roomie Universe",
      "project.roomie.universeCopy": "A visual language built through associations between fashion, art, affection, identity, and culture. Each series opens a different door into the Roomie universe.",
      "project.roomie.editorialTitle": "Editorial Design",
      "project.roomie.editorialCopy": "Editorial systems that communicate Roomie’s perspective, community, and proposals. The selection organizes information, images, and typographic rhythm into clear, contemporary, and sensitive pieces.",
      "project.roomie.academyTitle": "Academy and Content",
      "project.roomie.academyCopyOne": "Roomie Academia is a learning platform specializing in slow fashion, communication, trends, conscious consumption, and inclusion, directed by Pope Cerimedo. Its courses—including ID Personal and Future Sense—are designed for professionals, students, teenagers, and anyone interested in developing a more critical and contemporary perspective on identity, design, and the fashion industry.",
      "project.roomie.academyCopyTwo": "My role is to build the visual identity and produce all the communication and promotional materials for each program: concepts, images, graphic systems, and social media pieces that translate the academic content into a clear, sensitive, and recognizable language.",
      ...
      "project.roomie.selectionTitle": "Rebranding",
      "project.roomie.selectionCopyOne": "I redesigned Roomie’s identity to support its transition from a platform that sold clothing, organized pop-ups, and had a physical space into a project devoted entirely to fashion curation, editorial content, and culture.",
      "project.roomie.selectionCopyTwo": "I built a more typographic and sensitive system, with a more precise visual selection and a coherent voice. Today, I lead that direction, the curation, and the day-to-day development of all its content.",
      ...
      "project.roomie.loveEditorial": "Some posts begin with texts published on Roomie’s blog. In collaboration with Valentina Preiti, a member of the team and the author of the texts, I develop the photographic and editorial curation of each article, building a visual reading that supports the material and translates it into a language for social media.",
      "project.roomie.loveCredit": "Texts x Valentina Preiti",
      ...
      "project.treSorelle.intro1": "Tre Sorelle is a modestwear house born in Riyadh. From the beginning, I took ownership of its complete creative universe: I built the identity, defined the brand language, and directed how that vision would become product, campaign, and communication.",
      "project.treSorelle.intro2": "I work alongside its founders as creative director and lead designer. Every visual decision —from the logo to a daily Reel— follows one strategy: building a Saudi identity with local roots and international reach.",
      "project.treSorelle.identityTitle": "Brand identity and visual universe",
      "project.treSorelle.identityCopy": "The project began with the creation of the logo, isotype, typographic system, color palette, and the curation of its visual world. I built a calm and precise system where three lines meet to represent the three sisters, creating a brand that remains recognizable even without showing a garment.",
      "project.treSorelle.directionTitle": "Collection I / Origine",
      "project.treSorelle.directionCopy": "I named the first collection and every garment, then directed the photoshoot alongside the photographer. The campaign needed to feel rooted in the abaya, Riyadh, and Saudi Arabia, while speaking in English and projecting the potential of a worldwide brand. Fruit, vegetables, and sculptural gestures brought freshness and a distinct position beyond the traditional codes of regional competitors.",
      "project.treSorelle.campaignCaption": "Rooted in the abaya. Made in Riyadh. Created to move from a local origin toward a worldwide fashion house.",
      "project.treSorelle.socialTitle": "Strategy, content, and daily management",
      "project.treSorelle.socialCopy": "I designed the brand’s first approach to social media from scratch: strategy, feed architecture, content pillars, tone of voice, captions, carousels, Reels, Stories, calendar, and measurement system. Today I direct, create, and publish content every day across Instagram and TikTok, maintaining one consistent voice across both platforms.",
      "project.treSorelle.impactTitle": "A launch that started from zero and found its audience.",
      ...
      "project.treSorelle.impactNote": "Launch-period results from July 20 to August 7, 2026. Beyond reach, the campaign generated creator interest, reposts, and early business enquiries.",
