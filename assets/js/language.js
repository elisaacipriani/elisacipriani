(function () {
  ...
  const copy = {
    es: {
      ...
      "works.meta.roomie": "Diseño Editorial, Contenido y Curaduría<br>2026 — Presente",
      "works.meta.treSorelle": "Dirección Creativa e Identidad de Marca<br>2026 — Presente",
      ...
      "experience.itemTreSorelle": "Dirección creativa, diseño gráfico y gestión de redes sociales en Tre Sorelle.",
      ...
      "project.roomie.role": "Diseño editorial · Contenido gráfico para redes · Curaduría de contenido",
      "project.roomie.present": "Presente",
      "project.roomie.area": "Diseño Editorial, Contenido Gráfico y Curaduría",
      "project.roomie.date": "2026 — Presente",
      "project.roomie.kicker": "Plataforma Cultural y de Diseño Independiente",
      "project.roomie.intro": "En Roomie desarrollo universos editoriales capaces de conectar moda, arte y cultura. Mi trabajo combina criterio visual, investigación y narrativa para transformar ideas en presentaciones, contenidos y series gráficas con una identidad reconocible.",
      "project.roomie.moodboardTitle": "Archivo Roomie",
      "project.roomie.moodboardCopy": "Fotografías del archivo de Roomie: escenas, personas, espacios y momentos que registran su historia y su comunidad.",
      "project.roomie.universeTitle": "Roomie Universo",
      "project.roomie.universeCopy": "Un lenguaje visual construido con asociaciones entre moda, arte, afectos, identidad y cultura. Cada serie abre una puerta distinta dentro del universo Roomie.",
      "project.roomie.editorialTitle": "Diseño Editorial",
      "project.roomie.editorialCopy": "Sistemas editoriales para comunicar la mirada, la comunidad y las propuestas de Roomie. La selección organiza información, imágenes y ritmo tipográfico en piezas claras, contemporáneas y sensibles.",
      "project.roomie.academyTitle": "Academia y Contenidos",
      "project.roomie.academyCopyOne": "Roomie Academia es una plataforma de formación especializada en moda lenta, comunicación, tendencias, consumo consciente e inclusión, dirigida por Pope Cerimedo. Sus cursos —entre ellos ID Personal y Future Sense— están pensados para profesionales, estudiantes, adolescentes y personas interesadas en desarrollar una mirada más crítica y actual sobre la identidad, el diseño y la industria de la moda.",
      "project.roomie.academyCopyTwo": "Mi rol es construir la identidad visual y producir todo el material de comunicación y difusión de cada programa: conceptos, imágenes, sistemas gráficos y piezas para redes que traducen los contenidos académicos a un lenguaje claro, sensible y reconocible.",
      "project.roomie.coursesLabel": "Cursos",
      "project.roomie.directionLabel": "Dirección",
      "project.roomie.socialTitle": "Series Gráficas para Redes",
      "project.roomie.socialCopy": "Cada serie parte de una idea editorial y construye su propio recorrido visual. Las imágenes funcionan como asociaciones: abren conversaciones sobre moda, afectos, identidad, cultura y formas de habitar el presente.",
      "project.roomie.mimesis": "Moda, cuerpo y referencias animales.",
      "project.roomie.selectionTitle": "Rebranding",
      "project.roomie.selectionCopyOne": "Rediseñé la identidad de Roomie para acompañar su transición: de una plataforma que vendía indumentaria, organizaba pop ups y tenía un espacio físico, a un proyecto dedicado por completo a la curaduría de moda, el contenido editorial y la cultura.",
      "project.roomie.selectionCopyTwo": "Construí un sistema más tipográfico y sensible, con una selección visual más precisa y una voz coherente. Hoy llevo adelante esa dirección, la curaduría y el desarrollo cotidiano de todo el contenido.",
      "project.roomie.instagramLink": "Ver @roomiedesign en Instagram ↗︎",
      "project.roomie.resultsContextTitle": "Cuenta de Redes y Resultados",
      "project.roomie.profileCaption": "Perfil Editorial",
      "project.roomie.resultsCaptionOne": "Te Amo, Yo Tampoco — Resultados 01",
      "project.roomie.resultsCaptionTwo": "Yo También Te Amo — Resultados 02",
      "project.roomie.love": "Una narrativa visual sobre deseo, distancia y vulnerabilidad.",
      "project.roomie.loveEditorial": "Algunos posteos parten de textos publicados en el blog de Roomie. En colaboración con Valentina Preiti, integrante del equipo y autora de los textos, desarrollo la curaduría fotográfica y editorial de cada nota, construyendo una lectura visual que acompaña el material y lo traduce al lenguaje de redes.",
      "project.roomie.loveCredit": "Textos x Valentina Preiti",
      "project.roomie.blogLink": "Leer el blog ↗︎",
      "project.roomie.tea": "Rituales, objetos y gestos reunidos como archivo sensible.",
      "project.roomie.resultsTitle": "Contenido Destacado en Instagram",
      "project.roomie.resultsCopy": "Publicaciones que conectaron especialmente con la comunidad de Roomie. La selección reúne contenidos editoriales, piezas de archivo y resultados de alcance e interacción.",
      "project.roomie.closing": "Curar también es diseñar:<br>elegir qué mirar,<br>cómo conectarlo y qué historia<br>puede aparecer.",
      "project.treSorelle.kicker": "Una casa de moda saudí con una mirada propia",
      "project.treSorelle.heroNote": "Collection I / Origine<br>Riyadh, Arabia Saudita",
      "project.treSorelle.role": "Dirección Creativa Integral, Identidad de Marca, Diseño Gráfico y Social Media Management",
      "project.treSorelle.date": "2026 — Presente",
      "project.treSorelle.introTitle": "Una dirección creativa de punta a punta.",
      "project.treSorelle.intro1": "Tre Sorelle es una casa de modestwear nacida en Riyadh. Desde el inicio asumí la totalidad de su universo creativo: construí la identidad, definí el lenguaje de marca y dirigí cómo esa visión debía transformarse en producto, campaña y comunicación.",
      "project.treSorelle.intro2": "Trabajo junto a sus fundadoras como directora creativa y responsable del diseño de la marca. Cada decisión visual —del logo a un reel diario— responde a una misma estrategia: crear una identidad saudí con raíces locales y proyección internacional.",
      "project.treSorelle.identityTitle": "Identidad de marca y universo visual",
      "project.treSorelle.identityCopy": "El proyecto comenzó con la creación del logo, el isotipo, la selección tipográfica, la paleta y la curaduría del mundo visual. Construí un sistema sereno y preciso, donde tres líneas se encuentran para representar a las tres hermanas y dar origen a una marca reconocible incluso sin mostrar una prenda.",
      "project.treSorelle.directionTitle": "Collection I / Origine",
      "project.treSorelle.directionCopy": "Creé el nombre de la primera colección y de cada prenda, y dirigí el photoshoot junto a la fotógrafa. La campaña debía sentirse arraigada en la abaya, Riyadh y Arabia Saudita, pero hablar en inglés y proyectarse como una marca worldwide. Frutas, verduras y gestos escultóricos aportaron frescura y una identidad propia frente a los códigos tradicionales de la competencia.",
      "project.treSorelle.campaignCaption": "Rooted in the abaya. Made in Riyadh. Created to move from a local origin toward a worldwide fashion house.",
      "project.treSorelle.socialTitle": "Estrategia, contenido y gestión diaria",
      "project.treSorelle.socialCopy": "Diseñé desde cero el primer acercamiento de la marca a redes: estrategia, arquitectura del feed, pilares, tono de voz, captions, carouseles, reels, stories, calendario y sistema de medición. Hoy dirijo, creo y publico contenido todos los días en Instagram y TikTok, sosteniendo una voz consistente entre ambas plataformas.",
      "project.treSorelle.impactTitle": "Un lanzamiento que partió de cero y encontró audiencia.",
      "project.treSorelle.metricInstagram": "visualizaciones en Instagram",
      "project.treSorelle.metricTikTok": "visualizaciones en TikTok",
      "project.treSorelle.metricFollowers": "seguidores netos en Instagram",
      "project.treSorelle.impactNote": "Resultados del período de lanzamiento, del 20 de julio al 7 de agosto de 2026. Además de alcance, la campaña generó interés de creadores, reposts y consultas comerciales tempranas.",
      "project.treSorelle.credit": "Dirección creativa integral, identidad de marca, diseño gráfico, campaña y social media management: Elisa Cipriani.<br>Fundadoras de Tre Sorelle: Razan ALDuhaih y Ghadi Abdullah.",
    ...
    en: {
      ...
      "home.mobileCopy": "A multidisciplinary designer from Buenos Aires, Argentina. Exploring arts, fashion, and culture through handmade practices. Values the creative process where ideas and materials need to become projects.",
      ...
      "works.meta.roomie": "Editorial Design, Content and Curation<br>2026 — Present",
      "works.meta.treSorelle": "Creative Direction and Brand Identity<br>2026 — Present",
      ...
      "experience.itemTreSorelle": "Creative direction, graphic design, and social media management at Tre Sorelle.",
      ...
      "project.roomie.role": "Editorial design · Graphic content for social media · Content curation",
      "project.roomie.present": "Present",
      "project.roomie.area": "Editorial Design, Graphic Content, and Curation",
      "project.roomie.date": "2026 — Present",
      "project.roomie.kicker": "Independent Culture and Design Platform",
      "project.roomie.overview": "Roomie is a fashion and culture platform built around curation, editorial thinking and the exchange of ideas. What began as a project connected to clothing, pop-ups and a physical space gradually evolved into something broader: a place to observe fashion through images, writing, research, people and culture.<br><br>Rather than following fashion only through products or trends, Roomie approaches it as a way of reading the present, creating connections between what people wear and the cultural worlds that surround them.",
      "project.roomie.intro": "As Roomie evolved, its visual language needed to evolve with it.<br><br>Elisa’s role has been to shape how that point of view becomes visible, developing editorial worlds where fashion can enter into conversation with art, identity, affection and culture. Research, image selection, typography and narrative are treated as parts of the same process, allowing different subjects and formats to remain connected by a recognizable sensibility.",
      "project.roomie.moodboardTitle": "Roomie Archive",
      "project.roomie.moodboardCopy": "Roomie’s archive is part of that language.<br><br>Photographs of people, spaces, gatherings and everyday moments are revisited not simply as documentation, but as material for new visual narratives. Together, they preserve the memory of the project while giving its history an active place within its current identity.",
      "project.roomie.universeTitle": "Roomie Universe",
      "project.roomie.universeCopy": "The transition from retail space to editorial platform called for more than a visual refresh. It required a different way of organizing the project.",
      "project.roomie.editorialTitle": "Editorial Design",
      "project.roomie.editorialCopy": "Across Roomie’s communication, the objective is not to make every piece look the same, but to make each one feel as though it comes from the same perspective.<br><br>Information, photography and typography are organized through recurring editorial principles, creating enough structure for recognition while leaving space for each subject to develop its own character.<br><br>The system allows Roomie to move between cultural references, community, fashion, events and new proposals without reducing them to a single visual formula.",
      "project.roomie.academyTitle": "Academy and Content",
      "project.roomie.academyCopyOne": "That editorial language also extends into Roomie Academia, the project’s educational platform directed by Pope Cerimedo.<br><br>Focused on subjects including slow fashion, communication, trends, conscious consumption and inclusion, Academia approaches education through the same critical perspective that defines Roomie. Its programs, including ID Personal and Future Sense, translate questions around fashion and identity into spaces for learning and discussion.",
      "project.roomie.academyCopyTwo": "Elisa develops the visual language surrounding each course, creating concepts, image worlds and graphic systems that respond to the subject of the program while remaining connected to Roomie’s broader identity. Rather than applying one fixed template, each course becomes its own visual chapter within the same editorial universe.",
      "project.roomie.coursesLabel": "Courses",
      "project.roomie.directionLabel": "Direction",
      "project.roomie.socialTitle": "Graphic Series for Social Media",
      "project.roomie.socialCopy": "Each series begins with an editorial idea and builds its own visual journey. Images work through association, opening conversations about fashion, affection, identity, culture, and ways of inhabiting the present.",
      "project.roomie.mimesis": "Fashion, the body, and animal references.",
      "project.roomie.selectionTitle": "Rebranding",
      "project.roomie.selectionCopyOne": "Elisa redesigned Roomie’s identity around this new stage, moving toward a more typographic, flexible and editorial system. The visual selection became more precise, the use of type more deliberate, and the relationship between text and image more central.",
      "project.roomie.selectionCopyTwo": "The result is an identity that does not depend on a fixed aesthetic. Its consistency comes instead from rhythm, curation and a particular way of creating associations between ideas.",
      "project.roomie.instagramLink": "View @roomiedesign on Instagram ↗︎",
      "project.roomie.resultsContextTitle": "Social Media Account & Results",
      "project.roomie.profileCaption": "Editorial Profile",
      "project.roomie.resultsCaptionOne": "Te Amo, Yo Tampoco — Results 01",
      "project.roomie.resultsCaptionTwo": "Yo También Te Amo — Results 02",
      "project.roomie.love": "A visual narrative about desire, distance, and vulnerability.",
      "project.roomie.loveEditorial": "Writing became another starting point for the visual system.<br><br>Some editorial series originate in texts written for Roomie’s blog by Valentina Preiti. Working from those ideas, Elisa develops the photographic and editorial curation of each piece, looking for images that can extend the text rather than simply illustrate it.<br><br>The process then continues into social media, where the original material is reinterpreted through sequencing, scale, typography and image. A written piece becomes a visual reading, adapted to a different rhythm without losing the intention of the original text.",
      "project.roomie.loveCredit": "Texts by Valentina Preiti",
      "project.roomie.blogLink": "Read the blog ↗︎",
      "project.roomie.tea": "Rituals, objects, and gestures gathered as a sensitive archive.",
      "project.roomie.resultsTitle": "Featured Content on Instagram",
      "project.roomie.resultsCopy": "Posts that connected especially well with Roomie’s community. The selection brings together editorial content, archive pieces, and reach and interaction results.",
      "project.roomie.closing": "Curation is also design:<br>choosing what to look at,<br>how to connect it, and what story might appear.",
      "project.treSorelle.kicker": "A Saudi fashion house with a viewpoint",
      "project.treSorelle.heroNote": "Collection I / Origine<br>Riyadh, Saudi Arabia",
      "project.treSorelle.role": "Creative Direction, Brand Identity, Graphic Design, and Social Media Management",
      "project.treSorelle.date": "2026 — Present",
      "project.treSorelle.introTitle": "Creative direction from beginning to end.",
      "project.treSorelle.intro1": "<strong>Tre Sorelle began in Riyadh with the ambition of building a modest fashion house that could feel deeply connected to its origin without being visually confined by it.</strong>",
      "project.treSorelle.intro2": "Working alongside the founders from its earliest stage, Elisa shaped the brand as a complete creative system, bringing identity, image, product narrative and communication into one shared language. The objective was not simply to launch a collection, but to establish a world distinctive enough to grow with the brand.",
      "project.treSorelle.identityTitle": "Brand identity and visual universe",
      "project.treSorelle.identityCopy": "<strong>The first step was to give that world a recognizable visual structure.</strong><br><br>Elisa developed the logo, symbol, typographic system, color palette and broader art direction around a language of restraint, precision and repetition. At the center of the identity, three interconnected forms reference the three sisters behind the name, transforming the story of Tre Sorelle into a graphic device that could live independently from the product itself.<br><br>The result was conceived less as a logo in isolation and more as a flexible system, capable of creating recognition through proportion, rhythm and consistency.",
      "project.treSorelle.directionTitle": "Collection I / Origine",
      "project.treSorelle.directionCopy": "<strong>Once the identity had its structure, the next challenge was to give it an atmosphere.</strong><br><br>Elisa developed the naming for the first collection and its individual pieces, then translated the brand language into the direction of its debut campaign alongside the photographer.<br><br>The imagery needed to remain unmistakably connected to the abaya, Riyadh and Saudi Arabia, while avoiding the visual conventions already dominant within the category. Organic forms, produce, sculptural compositions and controlled gestures introduced an unexpected tension into the images, placing the garments within a world that felt local in origin but broader in visual language.",
      "project.treSorelle.campaignCaption": "Rooted in the abaya.<br>Born in Riyadh.<br>A Saudi fashion identity shaped through a contemporary international language.",
      "project.treSorelle.socialTitle": "Strategy, content, and daily management",
      "project.treSorelle.socialCopy": "<strong>The launch then moved from a static identity into a living communication system.</strong><br><br>Elisa translated the same visual principles into Tre Sorelle’s first digital presence, defining the feed architecture, content pillars, editorial pacing, tone of voice and formats across Instagram and TikTok.<br><br>Photography, typography, motion and copy were treated as parts of the same system rather than separate pieces of content. This allowed the brand to move between campaign imagery, product detail, Reels, Stories and everyday publishing while maintaining a consistent visual rhythm and point of view.",
      "project.treSorelle.impactTitle": "Tre Sorelle launched on July 20, 2026.",
      "project.treSorelle.metricInstagram": "Instagram views",
      "project.treSorelle.metricTikTok": "TikTok views",
      "project.treSorelle.metricFollowers": "net Instagram followers",
      "project.treSorelle.impactNote": "During its first weeks, the new visual and digital system began moving beyond presentation into response, generating reach, reposts, creator interest and early business enquiries.<br><br>For a brand beginning without an established audience, the launch became the first test of the identity in public. Not only whether it could be seen, but whether its visual language was distinctive enough to be recognized, shared and remembered.",
      "project.treSorelle.credit": "Creative direction, brand identity, graphic design, campaign, and social media management: Elisa Cipriani.<br>Tre Sorelle founders: Razan ALDuhaih and Ghadi Abdullah.",
