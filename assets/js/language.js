(function () {
  ...
  const copy = {
    es: {
      ...
      "project.roomie.academyCopy": "Diseño de materiales para Future Sense, un espacio formativo donde la curaduría de referentes, tendencias y contextos se vuelve una herramienta para mirar más allá de lo inmediato.",
      ...
      "project.roomie.selectionTitle": "Selección de posteos y stories",
      "project.roomie.selectionCopy": "Una constelación de contenidos donde conviven moda, arte, cultura y formación.",
      ...
      "project.roomie.closing": "Curar también es diseñar:<br>elegir qué mirar, cómo conectarlo y qué historia<br>puede aparecer.",
    ...
    en: {
      ...
      "project.roomie.academyCopy": "Material design for Future Sense, a learning space where the curation of references, trends, and contexts becomes a tool for looking beyond the immediate.",
      ...
      "project.roomie.selectionTitle": "Posts and stories selection",
      "project.roomie.selectionCopy": "A constellation of content bringing together fashion, art, culture, and learning.",
      ...
      "project.roomie.closing": "Curation is also design:<br>choosing what to look at, how to connect it, and what story<br>might appear.",
