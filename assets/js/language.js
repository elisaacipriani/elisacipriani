(function () {
  ...
  const copy = {
    es: {
      ...
      "project.roomie.academyCopy": "Roomie Academia es una plataforma de formación especializada en moda lenta, comunicación, tendencias, consumo consciente e inclusión, dirigida por Pope Cerimedo. Sus cursos —entre ellos ID Personal y Future Sense— están pensados para profesionales, estudiantes, adolescentes y personas interesadas en desarrollar una mirada más crítica y actual sobre la identidad, el diseño y la industria de la moda. Mi rol es construir la identidad visual y producir todo el material de comunicación y difusión de cada programa: conceptos, imágenes, sistemas gráficos y piezas para redes que traducen los contenidos académicos a un lenguaje claro, sensible y reconocible.",
      ...
      "project.roomie.selectionCopy": "Rediseñé la identidad de Roomie para acompañar su transición: de una plataforma que vendía indumentaria, organizaba pop ups y tenía un espacio físico, a un proyecto dedicado por completo a la curaduría de moda, el contenido editorial y la cultura. Construí un sistema más tipográfico y sensible, con una selección visual más precisa y una voz coherente. Hoy llevo adelante esa dirección, la curaduría y el desarrollo cotidiano de todo el contenido.",
      "project.roomie.instagramLink": "Ver @roomiedesign en Instagram ↗",
      ...
      "project.roomie.blogLink": "Leer el blog ↗",
    ...
    en: {
      ...
      "project.roomie.academyCopy": "Roomie Academia is a learning platform specializing in slow fashion, communication, trends, conscious consumption, and inclusion, directed by Pope Cerimedo. Its courses—including ID Personal and Future Sense—are designed for professionals, students, teenagers, and anyone interested in developing a more critical and contemporary perspective on identity, design, and the fashion industry. My role is to build the visual identity and produce all the communication and promotional materials for each program: concepts, images, graphic systems, and social media pieces that translate the academic content into a clear, sensitive, and recognizable language.",
      ...
      "project.roomie.selectionTitle": "Rebranding",
      "project.roomie.selectionCopy": "I redesigned Roomie’s identity to support its transition from a platform that sold clothing, organized pop-ups, and had a physical space into a project devoted entirely to fashion curation, editorial content, and culture. I built a more typographic and sensitive system, with a more precise visual selection and a coherent voice. Today, I lead that direction, the curation, and the day-to-day development of all its content.",
      "project.roomie.instagramLink": "View @roomiedesign on Instagram ↗",
      ...
      "project.roomie.blogLink": "Read the blog ↗",
